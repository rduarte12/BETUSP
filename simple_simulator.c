// mingw32\bin\gcc simple_simulator_Template.c -O3 -march=native -o simulador -Wall -lm
...
#define POW  38 // "100110"; -- POW Rx Ry Rz -- Rx <- Ry POW Rz Format: < inst(6) | Rx(3) | Ry(3) | Rz(3) | x >
