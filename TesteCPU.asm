...
nop                   ;  trocar por POW R0, R1, R2 no cpuram.mif na linha 164 => 164:1001100000010100;

; usar o resultado em R0 (2^4 = 16) para alterar um caractere
loadn r3, #'0'
add   r0, r0, r3      ; '0' + 16 adiciona o ascii do 0, pois '0' + 16 == @
loadn r4, #32
outchar r0, r4
